...
const pointSchema = new mongoose.Schema({
    ...
    responsible_person: { type: mongoose.Schema.Types.ObjectId, ref: 'EximclientUser' }, // Optional link to system user
    reviewer: { type: mongoose.Schema.Types.ObjectId, ref: 'EximclientUser' },
    created_by: { type: mongoose.Schema.Types.ObjectId, ref: 'EximclientUser' }, // User who created the task

    evidence: [{
        file_url: String,
        uploaded_by: { type: mongoose.Schema.Types.ObjectId, ref: 'EximclientUser' },
        uploaded_at: { type: Date, default: Date.now }
    }],
    history: [{
        action: String,
        changed_by: { type: mongoose.Schema.Types.ObjectId, ref: 'EximclientUser' },
